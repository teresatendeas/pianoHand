...
temporary_y=590 #For the front camera
...
while (cap1.isOpened() & cap2.isOpened()):
    ...
    array2 = handTracker.checkYLevel(frame2)
    print(array2)
    ...
    if len(filtered_contours) >= 2:
        ...
        for i in range(8):
            ...
            if (fingertips is not None) and (array2 != []):
